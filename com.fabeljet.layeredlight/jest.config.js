...
const config = {
  ...
  // cacheDirectory: "C:\\Users\\jorgenhs\\AppData\\Local\\Temp\\jest",
  ...
  testPathIgnorePatterns: [
    '/node_modules/',
    // Compiled build output — running the copies would test a stale build.
    '/.homeybuild/',
    // Playwright specs need the Playwright runner (npm run test:e2e), not Jest.
    '\\.pw\\.test\\.js$',
  ],
